...
const LockPage = () => {
    ...
    return (
        <>
            ...
            <div
                className={`relative pt-52 flex-grow flex flex-col place-content-center items-center xl:px-[6rem] pb-4 min-h-screen bg-cover bg-center bg-no-repeat bg-fixed 
