  ...
  return (
    <>
      ...
      <div className="max-w-full flex justify-center items-center relative">
        ...
        <MascotView openModal={openModal} setOpenModal={setOpenModal} />
        ...
        <Modal open={isOpenDailyPopup} className="h-screen w-screen flex flex-1 overflow-x-hidden overflow-y-auto">
