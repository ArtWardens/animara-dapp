...
const TasksCheck = ({ energyRechargable, handleUpdateRechargableEnergy }) => {
                                    ...
                                    <div className='flex flex-1 items-center' onClick={handleChargeEnergy}>
                                        ...
                                        <div class="ml-10 w-full text-2xl text-left">
                                            ...
                                            <div class="w-full text-lg">
                                                <span class="text-purple-500 text-xl">{energyRechargable}/3 &nbsp;</span>available today
                                            </div>
                                        </div>
                                    </div>
                                </div>
