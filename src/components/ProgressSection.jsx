...
const ProgressSection = ({ gameData, currentMascot }) => {
  ...
  return (
    <div className="absolute top-1/3 lg:top-1/5 w-full md:w-4/5 lg:w-2/3 mx-auto">
      {numberOfClicks >= 0 && numberOfClicks <= 10 && (
        <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              <img src={'../assets/images/hamar2.png'} width={40} height={40} className="h-6 w-6" alt="hamar 2" />
              <p>
                <span className=" passed-quest1 text-2xl font-extrabold outlinefont">{numberOfClicks}</span>
                <span className=" text-purple-900 font-semibold"> / 100</span>
              </p>
            </div>
            <div className="flex gap-2 items-center">
              <p className=" text-purple-900 font-semibold">100</p>
              <img src={'../assets/images/gem2.png'} width={40} height={40} className="h-6 w-6" alt="gem 2" />
            </div>
          </div>
          <ProgressBar
      ...
      {numberOfClicks >= 11 && numberOfClicks <= 20 && (
        <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              <img src={'../assets/images/hamar2.png'} width={40} height={40} className="h-6 w-6" alt="hamar 2" />
              <p>
                <span className=" text-yellow-400 text-2xl font-extrabold outlinefont">{numberOfClicks}</span>
                <span className=" text-purple-900 font-semibold">/200</span>
              </p>
            </div>
            <div className="flex items-center">
              <p className=" text-purple-900 font-semibold">100</p>
              <img src={'../assets/images/gem2.png'} width={40} height={40} className="h-6 w-6" alt="gem2" />
            </div>
          </div>
          <ProgressBar
      ...
      {numberOfClicks >= 21 && numberOfClicks <= 30 && (
        <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              <img src={'../assets/images/hamar2.png'} width={40} height={40} className="h-6 w-6" alt="hamar 2" />
      ...
      {numberOfClicks >= 31 && numberOfClicks <= 40 && (
        <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              <img src={'../assets/images/hamar2.png'} width={40} height={40} className="h-6 w-6" alt="hamar 2" />
      ...
      {numberOfClicks >= 41 && numberOfClicks <= 50 && (
        <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              <img src={'../assets/images/hamar2.png'} width={40} height={40} className="h-6 w-6" alt="hamar2" />
              <p>
                <span className=" text-yellow-400 text-2xl font-extrabold outlinefont">{numberOfClicks}</span>
