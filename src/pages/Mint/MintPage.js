                ...
                <div className="grid grid-cols-5 w-full gap-16 container pt-40 tracking-wider items-center">
                    <div className="col-span-2 text-amber-500 grid gap-8">
                        ...
                        <div className="border-2 border-transparent border-t-sky-300 border-dashed py-8 mt-4 font-outfit text-md">
                            ...
                            <p className="text-white text-xs">You must be on the Poleygon Mainnet to mint.</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <img src="../assets/images/clicker-character/nft-treasureBox.png" alt="NFT Treasure Box" className="object-contain w-96 -my-10"/>
