                ...
                <div className="w-[60%] flex flex-col space-y-[1.5rem]">
                    ...
                    <div className="flex flex-row items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-[#c4c4c4] text-sm font-normal font-outfit leading-[14px]">Gain priority access to token presales and <br/> receive 75,000 AniTokens.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-[#c4c4c4] text-sm font-normal font-outfit leading-[14px]">Accelerate your progress in our Tap to Earn <br/> system with exclusive boosters.</p>
                        </div>
                    </div>
                    ...
                    <div className="w-[90%] flex flex-col">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex flex-col text-center">
                                ...
                                <p className="text-[#c4c4c4] text-xs font-normal font-outfit leading-[14px]">Gain priority access to token presales and receive 75,000 AniTokens.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex flex-col text-center">
                                ...
                                <p className="text-[#c4c4c4] text-xs font-normal font-outfit leading-[14px]">Accelerate your progress in our Tap to Earn system with exclusive boosters.</p>
                            </div>
                        </div>
