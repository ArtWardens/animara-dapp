        ...
        numberOfClicks >= 0 && numberOfClicks <= 10 && <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              ...
              />
              <p>
                <span className=" passed-quest1 text-3xl font-extrabold outlinefont">
                  {numberOfClicks}
                </span>
                <span className=" text-purple-900 text-2xl font-semibold">{" "}/ {" "} 100</span>
              </p>
            </div>
        ...
        numberOfClicks >= 11 && numberOfClicks <= 20 && <div>
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              ...
              />
              <p>
                <span className=" text-yellow-400 text-3xl font-extrabold outlinefont">
                  {numberOfClicks}
                </span>
                <span className=" text-purple-900 text-2xl font-semibold">/200</span>
              </p>
            </div>
            <div className="flex text-3xl gap-2 items-center">
              <p className=" text-purple-900 font-semibold">100</p>
          ...
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              ...
              <p>
                ...
                <span className=" text-purple-900 text-2xl font-semibold">/500</span>
              </p>
            </div>
            <div className="flex text-3xl gap-2 items-center">
              <p className=" text-purple-900 font-semibold">100</p>
          ...
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              ...
              <p>
                ...
                <span className=" text-purple-900 text-2xl font-semibold">/1000</span>
              </p>
            </div>
            <div className="flex text-3xl gap-2 items-center">
              <p className=" text-purple-900 font-semibold">100</p>
          ...
          <div className="flex justify-between mx-4">
            <div className="flex items-center">
              ...
              <p>
                ...
                <span className=" text-purple-900 text-2xl font-semibold">/5000</span>
              </p>
            </div>
            <div className="flex text-3xl gap-2 items-center">
              <p className=" text-purple-900 font-semibold">100</p>
