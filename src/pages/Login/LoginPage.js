...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen relative flex">
      ...
      {/* Login Card Latest */}
      <div className="relative left-[50%] -translate-x-1/2 lg:left-[75%] self-center sm:h-[50.5rem] max-w-[25rem] sm:max-w-[27.5rem] rounded-[2.5rem] p-[2.5rem] gap-[1.25rem] bg-[#003459] shadow-[0.5rem_0.375rem_0.625rem_0_rgba(0,0,0,0.2)] font-bignoodle">
        {/* Upper Section */}
